...
## Using the same procedure, I worked through all the alerts in preparation for the Eradication & Recovery phase of the process. <br>(Because this is a HoneyNet and both VMs are isolated from any other network systems, I was not concerned that some of the Brute Force attempts were successful.)
