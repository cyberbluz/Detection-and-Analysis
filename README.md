...
## Using the same procedure, I worked through all the alerts in preparation for the Recovery phase of the process. <br>(Because this is a HoneyNet and both VMs are isolated from any other network systems, I was not concerned that the Brute Force attempts were successful.)
